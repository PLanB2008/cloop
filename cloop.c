  ...
  case CLOOP_COMPRESSOR_LZ4:
   {
    ...
    //err = LZ4_decompress_fast(clo->compressed_buffer, (size_t *) &compressed_length,
    //err = LZ4_decompress_safe(clo->compressed_buffer,
    //                     clo->buffer[clo->current_bufnum],(size_t *) &compressed_length, outputSize);
    err = LZ4_decompress_fast(clo->compressed_buffer,
                         clo->buffer[clo->current_bufnum],(size_t *) &compressed_length);
    if (err >= 0) 
    {
     err = 0;
